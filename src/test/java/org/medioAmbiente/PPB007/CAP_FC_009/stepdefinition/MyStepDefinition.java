package org.medioAmbiente.PPB007.CAP_FC_009.stepdefinition;

import io.cucumber.java.es.Dado;
import io.cucumber.java.es.Y;
import net.thucydides.core.annotations.Steps;
import org.medioAmbiente.PPB007.CAP_FC_009.step.MyStep;
...
public class MyStepDefinition {
    ...
    @Dado("^PPB007-CAPFC009 - Accedo al Navegador$")
    public void Accedo_Al_Navegador() throws InterruptedException{
        myStep.cargarPagina();
    }

    @Y("^PPB007-CAPFC009 - Acepto Cookies$")
