...
public class MyPage extends PageObject {
    ...
    @FindBy(xpath = "//a[@title=\"Sierra de Gádor, patrimonio natural e infraestructura verde de Almería (Libro). Andalucía\"]")
    ...
    public void seleccionarContenido() throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(getDriver(), 30);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title=\"Sierra de Gádor, patrimonio natural e infraestructura verde de Almería (Libro). Andalucía\"]")));
        JavascriptExecutor j = (JavascriptExecutor) getDriver();
