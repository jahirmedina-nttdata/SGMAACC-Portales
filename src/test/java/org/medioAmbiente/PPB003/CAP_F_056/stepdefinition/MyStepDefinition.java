package org.medioAmbiente.PPB003.CAP_F_056.stepdefinition;

import io.cucumber.java.es.Dado;
import io.cucumber.java.es.Y;
import net.thucydides.core.annotations.Steps;
import org.medioAmbiente.PPB003.CAP_F_056.step.MyStep;
...
public class MyStepDefinition {
    ...
    @Dado("^PPB003-CAPF056 - Accedo al Navegador$")
    public void Accedo_Al_Navegador() throws InterruptedException{
        myStep.cargarPagina();
    }


    @Y("^PPB003-CAPF056 - Aceptar Cookies$")
    public void Aceptar_Cookies() throws InterruptedException{
        myStep.aceptarCookies();
    }

    @Y("^PPB003-CAPF056 - Visualizar apartado Redes Sociales$")
    public void Visualizar_Apartado_Redes_Sociales()throws InterruptedException {
        myStep.visualizarRedesSociales();
    }

    @Y("^PPB003-CAPF056 - Clickar Seguir en Ventana Visitante de Twitter$")
    ...
    @Y("^PPB003-CAPF056 - Clickar Seguir pagina en Ventana Visitante de Facebook$")
    ...
    @Y("^PPB003-CAPF056 - Clickar Seguir en Infoca de Twitter$")
