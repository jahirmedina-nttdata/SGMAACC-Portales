package org.medioAmbiente.PPB003.CAP_F_124.page;
...
public class MyPage extends PageObject {
    ...
    @FindBy(xpath = "//div[contains(text(),'MAPAS')]")
    private WebElementFacade Mapa;
    ...
    @FindBy(xpath = "(//tr[1]//p[@class=\"evr-table-simple__thumb-txt\"])[2]")
    ...
    public void seleccionarCatMapas() throws InterruptedException {
