package org.medioAmbiente.PPB003.CAP_F_003.page;
...
public class MyPage extends PageObject {
    ...
    @FindBy(xpath = "//input[@id=\"_com_liferay_journal_web_portlet_JournalPortlet_codigoEspacioNatural_INSTANCE_zVHyL3yz\"]")
    private WebElementFacade Validar_RENPA;
    ...
    public void visualizarCodigoRENPA() throws InterruptedException {
        ...
        waitFor(2).second();
        String textflotante = Validar_RENPA.getAttribute("value");
        if(textflotante.equals("2025")) {
            Assert.assertTrue(true);
        }else{
            Assert.fail("No Coincide RENPA");
        }
    }
}
