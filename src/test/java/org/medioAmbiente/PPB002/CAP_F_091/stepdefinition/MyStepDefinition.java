package org.medioAmbiente.PPB002.CAP_F_091.stepdefinition;

import io.cucumber.java.es.Cuando;
import io.cucumber.java.es.Dado;
import io.cucumber.java.es.Y;
import net.thucydides.core.annotations.Steps;
import org.medioAmbiente.PPB002.CAP_F_091.step.MyStep;
...
public class MyStepDefinition {
    ...
    @Dado("^PPB002-CAPF091 - Cargando el Navegador$")
    public void Cargando_El_Navegador() throws InterruptedException {
        myStep.cargandoNavegador();
    }
    @Cuando("^PPB002-CAPF091 - Acepta las Cookies")
    public void Acepta_Cookies() throws InterruptedException {
        myStep.aceptarCookies();
    }

    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Portal de la Caza y la Pesca Continental")
    ...
    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Portal Andaluz del Cambio Climático")
    ...
    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Ventana del visitante")
    public void Pulsar_Sobre_El_Enlace_Ventana_Del_Visitante() throws InterruptedException {
        myStep.pulsarVentanaVisitante();
    }

    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Canal de Administración Electrónica")
    ...
    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Plan Infoca")
    public void Pulsar_Sobre_El_Enlace_Plan_Infoca() throws InterruptedException {
        myStep.pulsarPlanInfoca();
    }

    @Y("^PPB002-CAPF091 - Pulsar sobre el enlace Embalses y precipitaciones")
