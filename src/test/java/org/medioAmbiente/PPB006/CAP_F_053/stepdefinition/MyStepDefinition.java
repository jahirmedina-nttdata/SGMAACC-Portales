package org.medioAmbiente.PPB006.CAP_F_053.stepdefinition;

import io.cucumber.java.es.Dado;
import io.cucumber.java.es.Y;
import net.thucydides.core.annotations.Steps;
import org.medioAmbiente.PPB006.CAP_F_053.step.MyStep;
...
public class MyStepDefinition {
    ...
    @Dado("^PPB006-CAPF053 - Accedo al Navegador$")
    public void Accedo_Al_Navegador() throws InterruptedException{
        myStep.cargarPagina();
    }


    @Y("^PPB006-CAPF053 - Acepto Cookies$")
    public void Aceptar_Cookies() throws InterruptedException{
        myStep.aceptarCookies();
    }

    @Y("^PPB006-CAPF053 - Ubicarse en la seccion Tambien te puede interesar$")
