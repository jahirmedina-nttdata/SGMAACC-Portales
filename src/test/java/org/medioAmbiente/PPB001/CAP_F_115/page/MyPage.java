package org.medioAmbiente.PPB001.CAP_F_115.page;
...
public class MyPage extends PageObject {
    ...
    public void seleccionarCorrespondenciaCualquiera() throws InterruptedException {
        ...
        Correspondencia.selectByVisibleText("Cualquiera");
    }
    ...
    public void validarBusqueda() throws InterruptedException {
        List<WebElement> lista = getDriver().findElements(By.xpath("//div[@class=\"table-responsive\"]"));
        if (lista.size() != 0) {
