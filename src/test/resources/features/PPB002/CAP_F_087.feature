...
Característica: PPB002-CAP_F_087 - Visualizacion detalle Indicador
  ...
  Escenario: Cargando el Portal de Referencia
    ...
    Cuando PPB002-CAPF087 - Se haya cargado la web
    Y PPB002-CAPF087 - Aceptar las cookies
    Y PPB002-CAPF087 - Mostrar sin fecha
    Y PPB002-CAPF087 - Mostrar sin subtitulo
    Y PPB002-CAPF087 - Mostrar sin texto
